			...
			<div align="center">
				<form action="bookcontroller" method="post">
					...
					<table>
						<tr>
							<td>Book Name</td>
							<td><input type="text" name="bookName" id="bookName" value="<%=book.getBookName()%>"></td>
							<td><span id="spBookName"></span></td>
						</tr>

						<tr>
							<td>Book Author</td>
							<td><input type="text" name="bookAuthor" id="bookAuthor" value="<%=book.getBookAuthor()%>"></td>
							<td><span id="spBookAuthor"></span></td>
						</tr>

						<tr>
							<td>Book Price</td>
							<td><input type="text" name="bookPrice" id="bookPrice" value="<%=book.getBookPrice()%>"></td>
							<td><span id="spBookPrice"></span></td>
						</tr>

						<tr>
							<td>Book Publisher</td>
							<td><select id="bookPublisher" name="bookPublisher" value="<%=book.getBookPublisher()%>">
						...
						<tr>
							<td>Book Quantity</td>
							<td><input type="text" name="bookQuantity" id="bookQuantity" value="<%=book.getBookQuantity()%>"></td>
							<td><span id="spBookQuantity"></span></td>
						</tr>

						<tr>
							<td>Book Category</td>
							<td><input type="text" name="bookCategory" id="bookCategory" value="<%=book.getBookCategory()%>"></td>
							<td><span id="spBookCategory"></span></td>
						</tr>

						<tr>
							<td>Book Desc</td>
							<td><input type="text" name="bookDesc" id="bookDesc" value="<%=book.getBookDesc()%>"></td>
