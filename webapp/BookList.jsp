        	...
        	{%>
				<div class="templatemo_product_box">
					...
					<div class="product_info">
						...
						<div class="buy_now_button">
							<a
								href="cartcontroller?action=addCart&bookId=<%=book.getBookId()%>&bookName=<%=book.getBookName()%>&bookQuantity=<%=book.getBookQuantity() %>&bookPrice=<%=book.getBookPrice()%>">
								Add To Cart</a>
						</div>
				...
				<div class="templatemo_product_box">
					...
					<div class="product_info">
						...
						<div class="detail_button">
							<a
								href="bookcontroller?action=Details&bookId=<%=book.getBookId() %>">Details</a>
						</div>
					</div>
                 </div>
					<% }
