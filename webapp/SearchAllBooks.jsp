   	      ...
   	      <img src="<%= book.getBookImg().substring(book.getBookImg().indexOf("BookStore_Image")) %>" alt="image" />
                <div class="product_info">
                  ...
                  <h3><%=book.getBookPrice() %></h3>
                    <div class="buy_now_button"><a href="cartcontroller?action=addCart&bookId=<%=book.getBookId() %>&bookName=<%=book.getBookName()%> &bookPrice=<%=book.getBookPrice()%>" >Add to Cart</a></div>
