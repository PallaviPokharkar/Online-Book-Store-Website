...
%>
	<div id="templatemo_menu">
		<ul>
            ...
            {%>
			<li><a href="bookcontroller?action=AddBook">Add Book</a></li>
			<% }
            else 
            {%>
			<li><a href="bookcontroller?action=books">Books</a></li>
			<%} %>
			
			
			<%if(username != null && username.equals("admin"))
            	{%>
			<li><a href="customercontroller?action=showCustomer">Show All Customer</a></li>
			<% }
            else 
            {%>
